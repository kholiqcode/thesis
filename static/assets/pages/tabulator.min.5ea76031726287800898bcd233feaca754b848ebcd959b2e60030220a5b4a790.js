...
!(function (e, t) {
    ...
    Array.prototype.includes ||
      Object.defineProperty(Array.prototype, "includes", {
        value: function (e, t) {
          ...
          if (0 === i) return !1;
          for (
            var n = 0 | t, s = Math.max(n >= 0 ? n : i - Math.abs(n), 0);
            s < i;
  ...
  (t.prototype.createHeadersElement = function () {
    ...
    (t.prototype._addColumn = function (e, t, o) {
      ...
      if (o && a > -1) {
        var r = this.columns.indexOf(o.getTopColumn()),
          l = o.getElement();
        t
          ? (this.columns.splice(r, 0, i), l.parentNode.insertBefore(s, l))
      ...
      return new Promise(function (l, c) {
        if (
          ...
          if (
            !o &&
            (s = r.offsetLeft) > 0 &&
            s + r.offsetWidth < i.element.clientWidth
          )
            return !1;
          (n = r.offsetLeft + a),
            (n = Math.max(
    ...
    (t.prototype.getFlexBaseWidth = function () {
      var e = this,
        ...
        o = 0;
      return (
        e.rowManager.element.scrollHeight > e.rowManager.element.clientHeight &&
          (t -=
      ...
      return new Promise(function (n, s) {
        ...
        i._reIndexColumns(),
          ...
          i.table.modExists("columnCalcs") &&
            i.table.modules.columnCalcs.recalc(i.table.rowManager.activeRows),
          i.redraw(!0),
    ...
    (t.prototype.redraw = function (e) {
      e &&
        (h.prototype.helpers.elVisible(this.element) &&
          this._verticalAlignHeaders(),
  ...
  (o.prototype.getElement = function () {
    ...
    (o.prototype.setHeaderFilterValue = function (e) {
      this._column.table.modExists("filter", !0) &&
        this._column.table.modules.filter.setHeaderFilterValue(this._column, e);
    }),
  ...
  (n.prototype.createElement = function () {
    ...
    (n.prototype._buildColumnHeader = function () {
      ...
      if (
        ...
        _typeof(o.options.responsiveLayout) &&
      ...
      t.field && this.element.setAttribute("tabulator-field", t.field),
        ...
        (this.titleElement.style.textAlign =
          this.definition.headerHozAlign || this.table.options.headerHozAlign);
    }),
  ...
  (s.prototype.createHolderElement = function () {
    ...
    (s.prototype.findRow = function (e) {
      ...
      if (e instanceof r) return e._getSelf() || !1;
      if ("undefined" != typeof HTMLElement && e instanceof HTMLElement) {
        return (
    ...
    (s.prototype.scrollToRow = function (e, t, o) {
      ...
      return new Promise(function (e, l) {
        if (s > -1) {
              ...
              case "classic":
                (i = h.prototype.helpers.elOffset(a).top),
                  (t =
                    ...
                    Math.abs(n.element.scrollTop + n.element.clientHeight - i)
                      ? "bottom"
                      : "top");
                break;
              case "virtual":
          ...
          if (
            !o &&
            h.prototype.helpers.elVisible(a) &&
            (r =
              h.prototype.helpers.elOffset(a).top -
              h.prototype.helpers.elOffset(n.element).top) > 0 &&
            r < n.element.clientHeight - a.offsetHeight
          )
            return !1;
          switch (n.renderMode) {
            case "classic":
              n.element.scrollTop =
                h.prototype.helpers.elOffset(a).top -
                h.prototype.helpers.elOffset(n.element).top +
                n.element.scrollTop;
              break;
            case "virtual":
    ...
    (s.prototype.addRowActual = function (e, t, o, i) {
      var n,
        s,
        a = e instanceof l ? e : new l(e || {}, this),
        r = this.findAddRowPos(t),
        c = -1;
      if (
        (!o &&
          this.table.options.pagination &&
          ...
          r
            ? s.length
              ...
              : this.activeRows.length &&
                ((o = this.activeRows[this.activeRows.length - 1]), (r = !1))
            : s.length &&
              ((o = s[s.length - 1]),
        ...
        u.length > 1 &&
          (!o || (o && -1 == u.indexOf(o))
            ? r
              ? u[0] !== a &&
                ((o = u[0]), this._moveRowInArray(a.getGroup().rows, a, o, !r))
              : u[u.length - 1] !== a &&
                ((o = u[u.length - 1]),
                this._moveRowInArray(a.getGroup().rows, a, o, !r))
            : this._moveRowInArray(a.getGroup().rows, a, o, !r));
      }
      return (
    ...
    (s.prototype.refreshActiveData = function (e, t, o) {
        ...
        case "freeze":
          t
            ...
            : this.table.modExists("frozenRows") &&
              ...
              !0 !==
                (i = n.setDisplayRows(
                  s.modules.frozenRows.getRows(this.getDisplayRows(i - 1)),
                  i
          ...
          t
            ...
            : s.options.groupBy &&
              ...
              (s.modules.groupRows.getDisplayIndex() ||
                s.modules.groupRows.setDisplayIndex(this.getNextDisplayIndex()),
          ...
          t
            ...
            : s.options.dataTree &&
              ...
              (s.modules.dataTree.getDisplayIndex() ||
                s.modules.dataTree.setDisplayIndex(this.getNextDisplayIndex()),
          ...
          t
            ...
            : s.options.pagination &&
              ...
              (s.modules.page.getDisplayIndex() ||
                s.modules.page.setDisplayIndex(this.getNextDisplayIndex()),
              (i = s.modules.page.getDisplayIndex()),
              "local" == s.modules.page.getMode() &&
                s.modules.page.setMaxRows(this.getDisplayRows(i - 1).length),
              !0 !==
                (i = n.setDisplayRows(
      ...
      h.prototype.helpers.elVisible(n.element) &&
        (o
    ...
    (s.prototype.setDisplayRows = function (e, t) {
      ...
      return (
        t && void 0 !== this.displayRows[t]
          ...
          : (this.displayRows.push(e), (o = t = this.displayRows.length - 1)),
        ...
        e
          ? ((i.vDomTopPad = t
            ...
            (i.vDomBottomPad =
              i.vDomBottom == i.displayRowsCount - 1
                ? 0
                : Math.max(i.vDomScrollHeight - i.vDomTopPad - r - l, 0)))
          : ((this.vDomTopPad = 0),
  ...
  (a.prototype.compatabilityCheck = function () {
    ...
    (a.prototype.initialize = function () {
      ...
      this.holderEl.addEventListener("scroll", function () {
        ...
        e.scrollLeft != t &&
          ((e.scrollLeft = t), e.scroll(t - (e.vDomScrollPosLeft + e.window)));
      });
    }),
      ...
      if ("fitData" === this.table.options.layout) {
        if (
          ...
          i &&
            ...
            this.table.options.groupBy
              ? ((e = this.table.modules.groupRows.getGroups(!1)[0]),
                (t = e.getRows(!1)[0]))
              : (t = this.table.rowManager.getDisplayRows()[0]),
            t))
        ) {
          (o = t.getElement()), t.generateCells(), this.element.appendChild(o);
          ...
          for (
            o.parentNode.removeChild(o),
              ...
              s;
            s < this.table.columnManager.columnsByIndex.length;
            s++
          )
            this.table.columnManager.columnsByIndex[s].setWidth(
              this.fitDataColAvg
            );
    ...
    (a.prototype.addColRight = function () {
      ...
      i &&
        ...
        this.fitDataColAvg &&
          (t = i.getWidth()) === this.fitDataColAvg &&
          (i.reinitializeWidth(),
          (o = t - i.getWidth()) &&
            ((i.modules.vdomHoz.rightPos -= o),
    ...
    (a.prototype.removeColLeft = function () {
      var e,
        t = this.columns[this.leftCol];
      t &&
        t.modules.vdomHoz.rightPos < this.vDomScrollPosLeft &&
        ((e = this.table.rowManager.getVisibleRows()),
        e.forEach(function (e) {
          if ("group" !== e.type) {
            var o = e.getCell(t);
  ...
  var l = function (e, t) {
    var o =
      arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "row";
    (this.table = t.table),
      (this.parent = t),
      (this.data = {}),
      (this.type = o),
      ...
      if (e < this.cells.length - 1)
        for (var o = e + 1; o < this.cells.length; o++) {
          ...
          if (
            ...
            h.prototype.helpers.elVisible(i.getElement())
          ) {
            var n = !0;
            if (
  ...
  (u.prototype.build = function () {
    ...
    (u.prototype._configureCell = function () {
      ...
      if (
        ...
        e.column.vertAlign &&
          ...
          e.column.hozAlign &&
            (o.style.justifyContent = s[e.column.hozAlign] || "")),
    ...
    (u.prototype.getComponent = function () {
      return this.component || (this.component = new c(this)), this.component;
    });
  var d = function (e) {
    (this.table = e),
      (this.active = !1),
  ...
  (h.prototype.defaultOptions = {
    ...
    (h.prototype.initializeOptions = function (e) {
      ...
      for (var t in this.defaultOptions)
        t in e
          ...
          : "object" === _typeof(this.defaultOptions[t]) &&
    ...
    (h.prototype.destroy = function () {
      var e = this.element;
      for (
        h.prototype.comms.deregister(this),
          this.options.reactiveData &&
    ...
    (h.prototype.deleteRow = function (e) {
      ...
      return new Promise(function (o, i) {
        ...
        Array.isArray(e) || (e = [e]),
          ...
          l.sort(function (e, o) {
            return t.rowManager.rows.indexOf(e) > t.rowManager.rows.indexOf(o)
              ? 1
              : -1;
          }),
          l.forEach(function (e) {
    ...
    (h.prototype.clearFilter = function (e) {
      this.modExists("filter", !0) &&
        (this.modules.filter.clearFilter(e), this.rowManager.filterRefresh());
    }),
    ...
    (h.prototype.navigatePrev = function () {
      ...
      return (
        !(
          !this.modExists("edit", !0) || !(e = this.modules.edit.currentCell)
        ) && e.nav().prev()
      );
    }),
    ...
    (h.prototype.navigateLeft = function () {
      ...
      return (
        !(
          !this.modExists("edit", !0) || !(t = this.modules.edit.currentCell)
    ...
    (h.prototype.comms = {
      ...
      lookupTable: function (e, t) {
        ...
        if ("string" == typeof e) {
          ...
          e instanceof h
            ? (i = h.prototype.comms.matchElement(e)) && n.push(i)
            : Array.isArray(e)
            ? e.forEach(function (e) {
        ...
        e.forEach(function (e, i) {
          ...
          s
            ? ((n = i - o + s.getWidth()),
              this.table.options.responsiveLayout &&
                this.table.modExists("responsiveLayout", !0) &&
                (s.setWidth(0), this.table.modules.responsiveLayout.update()),
        ...
        function o(e, i, n, s) {
          ...
          return (
            e.forEach(function (e, t) {
              ...
              e.column.minWidth >= o
                ? c.push(e)
                : e.column.maxWidth && e.column.maxWidth < o
              ...
              o
                ? ((n = t(o)),
                  ...
                  e.definition.widthShrink &&
                    (u.push({ column: e, width: n > i ? n : i }),
                    (d += e.definition.widthShrink)))
                : (c.push({ column: e, width: 0 }),
  ...
  (f.prototype.getConnections = function (e) {
    var t,
      ...
      i = [];
    return (
      (t = h.prototype.comms.lookupTable(e)),
  ...
  (g.prototype.initializeColumn = function (e) {
    ...
    this.allowedTypes.forEach(function (n) {
      ...
      e.definition[a] &&
        (s = t.lookupAccessor(e.definition[a])) &&
        ((o = !0),
        (i[a] = { accessor: s, params: e.definition[a + "Params"] || {} }));
    }),
    ...
    (g.prototype.transformRow = function (e, t) {
      ...
      return (
        this.table.columnManager.traverse(function (e) {
          var s, a, r, l;
          e.modules.accessor &&
            (a = e.modules.accessor[o] || e.modules.accessor.accessor || !1) &&
  ...
  (b.prototype.initialize = function () {
    ...
    (b.prototype._loadDataProgressive = function () {
      return (
        this.table.rowManager.setData([]), this.table.modules.page.setPage(1)
      );
    }),
    ...
    (b.prototype.defaultConfig = { method: "GET" }),
    ...
    (b.prototype.defaultLoaderPromise = function (e, t, o) {
      ...
      return new Promise(function (s, a) {
        if (
          ...
          if (
            (i =
              "object" === _typeof(n.table.options.ajaxContentType)
  ...
  (E.prototype.initialize = function () {
    ...
    (E.prototype.getTreeChildren = function (e, t, o) {
      ...
      return (
        n.children &&
          (Array.isArray(n.children) || (n.children = this.generateChildren(e)),
  ...
  (C.prototype.download = function (e, t, o, i, n) {
    function s(o, i) {
      n
        ? !0 === n
          ? a.triggerDownload(o, i, e, t, !0)
          : n(o)
        : a.triggerDownload(o, i, e, t);
    }
    var a = this,
      r = !1;
    if (
    ...
    (C.prototype.triggerDownload = function (e, t, o, i, n) {
      ...
      (a = this.table.options.downloadReady.call(this.table, e, a)) &&
        (n
          ...
          : (s.setAttribute("href", window.URL.createObjectURL(a)),
    ...
    (C.prototype.downloaders = {
          ...
          return (
            e.columns.forEach(function (e) {
              ...
              if (e) {
                ...
                (i = { content: e.value, colSpan: e.width, rowSpan: e.height }),
                  t && (i.styles = t),
                  o.push(i);
              } else o.push("");
            }),
      ...
      xlsx: function (e, t, o) {
          ...
          return (
            e.forEach(function (e, i) {
              ...
              e.columns.forEach(function (e, t) {
                e
                  ? (n.push(
                      e.value instanceof Date || "object" !== _typeof(e.value)
                        ? e.value
        ...
        if (((r.SheetNames = []), (r.Sheets = {}), t.sheetOnly))
          return void o(i());
        if (t.sheets)
        ...
        t.documentProcessing && (r = t.documentProcessing(r)),
          ...
          o(
            (function (e) {
              for (
                var t = new ArrayBuffer(e.length), o = new Uint8Array(t), i = 0;
                i != e.length;
                ++i
              )
  ...
  (x.prototype.initializeColumn = function (e) {
    ...
    (x.prototype.edit = function (e, t, o) {
        ...
        if (c.currentCell === e) {
          ...
          return (
            e.column.modules.validate &&
              c.table.modExists("validate") &&
              "manual" != c.table.options.validationMode &&
              (o = c.table.modules.validate.validate(
                e.column.modules.validate,
                e,
                t
              )),
            !0 === o || "highlight" === c.table.options.validationMode
              ? (c.clearEditor(),
                ...
                e.setValue(t, !0),
                c.table.options.dataTree &&
                  c.table.modExists("dataTree") &&
                  c.table.modules.dataTree.checkForRestyle(e),
                !0 === o ||
                  (h.classList.add("tabulator-validation-fail"),
                  c.table.options.validationFailed.call(
                    c.table,
                    e.getComponent(),
                    t,
                    o
      ...
      switch (
        (t && t.stopPropagation(), _typeof(e.column.modules.edit.check))
      ) {
        case "function":
        ...
        if (
          ...
          this.mouseClick &&
            ...
            e.column.cellEvents.cellClick &&
              e.column.cellEvents.cellClick.call(this.table, t, r)),
          e.column.cellEvents.cellEditing &&
            e.column.cellEvents.cellEditing.call(this.table, r),
          c.table.options.cellEditing.call(this.table, r),
          (l =
            "function" == typeof e.column.modules.edit.params
              ? e.column.modules.edit.params(r)
    ...
    (x.prototype.maskInput = function (e, t) {
      ...
      e.addEventListener("keydown", function (t) {
        ...
        if (t.keyCode > 46) {
          if (o >= i.length)
            return t.preventDefault(), t.stopPropagation(), (r = !1), !1;
          switch (i[o]) {
            case n:
    ...
    (x.prototype.editors = {
      input: function (e, t, o, i, n) {
        function s(e) {
          ((null === a || void 0 === a) && "" !== r.value) || r.value !== a
            ? o(r.value) && (a = r.value)
            : i();
        }
        var a = e.getValue(),
          ...
          for (var l in n.elementAttributes)
            "+" == l.charAt(0)
              ? ((l = l.slice(1)),
                r.setAttribute(
                  l,
                  r.getAttribute(l) + n.elementAttributes["+" + l]
                ))
              : r.setAttribute(l, n.elementAttributes[l]);
        return (
          (r.value = void 0 !== a ? a : ""),
          t(function () {
          ...
          c.addEventListener("keydown", function (e) {
            switch (e.keyCode) {
              case 27:
                ...
                break;
              case 38:
                ("editor" == r || ("hybrid" == r && c.selectionStart)) &&
                  (e.stopImmediatePropagation(), e.stopPropagation());
                break;
              case 40:
                ("editor" == r ||
                  ("hybrid" == r && c.selectionStart !== c.value.length)) &&
                  (e.stopImmediatePropagation(), e.stopPropagation());
                break;
              case 35:
              case 36:
      ...
      select: function (e, t, o, i, n) {
        function s(t) {
          ...
          return (
            (o = t
              ? x.table.columnManager.getColumnByField(t)
        ...
        function a(t, o) {
          function i(e) {
            ...
            return o.indexOf(e.value) > -1 && c(e), s.push(e), a.push(e), e;
          }
          var s = [],
            a = [];
          ...
          n.sortValuesList &&
            ...
            "asc" !== n.sortValuesList && (s.reverse(), a.reverse())),
            (S = s),
            (P = a),
            r();
        }
            ...
            if (!o) {
              if (
                ...
                (t.label = n.listItemFormatter
                  ? n.listItemFormatter(t.value, t.label, e, o, t.itemParams)
                  : t.label),
                t.group
                  ? (o.classList.add("tabulator-edit-select-list-group"),
                    (o.tabIndex = 0),
                ...
                for (var i in t.elementAttributes)
                  "+" == i.charAt(0)
                    ? ((i = i.slice(1)),
                      o.setAttribute(
                        i,
                        T.getAttribute(i) + t.elementAttributes["+" + i]
                      ))
        ...
        function u(e) {
          var t = A[e];
          e > -1 &&
            (A.splice(e, 1), t.element && t.element.classList.remove("active"));
        }
        function d(e) {
          e || (e = H);
          var t = A.indexOf(e);
          t > -1 ? u(t) : (!0 !== z && A.length >= z && u(0), c(e)), f();
        }
        function p(e) {
          y(),
            e || (e = H),
            e && ((T.value = e.label), o(e.value)),
            (D = [e.value]);
        }
        function m(e) {
          e || y();
        ...
        function y() {
          k.parentNode && k.parentNode.removeChild(k), w();
        }
        function w() {
          ...
          for (var O in n.elementAttributes)
            "+" == O.charAt(0)
              ? ((O = O.slice(1)),
                T.setAttribute(
                  O,
                  T.getAttribute(O) + n.elementAttributes["+" + O]
                ))
              : T.setAttribute(O, n.elementAttributes[O]);
        return (
          (T.value = void 0 !== M || null === M ? M : ""),
          ...
          T.addEventListener("keydown", function (e) {
            ...
            switch (e.keyCode) {
              ...
              case 40:
                (t = S.indexOf(H)),
                  ("editor" == L || ("hybrid" == L && t < S.length - 1)) &&
                    (e.stopImmediatePropagation(),
                    e.stopPropagation(),
                    e.preventDefault(),
                    t < S.length - 1 &&
                      (-1 == t ? l(S[0], !z) : l(S[t + 1], !z)));
                break;
              case 37:
              case 39:
                e.stopImmediatePropagation(),
      ...
      autocomplete: function (e, t, o, i, n) {
        function s() {
          !0 === n.values
            ? (S = a())
            : "string" == typeof n.values && (S = a(n.values));
        }
        function a(t) {
          var o,
            i = {},
          ...
          return (
            (o = t
              ? E.table.columnManager.getColumnByField(t)
              : e.getColumn()._getSelf()),
            o
              ? (s.forEach(function (e) {
                  var t = o.getFieldValue(e);
        ...
        function b() {
          D.parentNode && D.parentNode.removeChild(D), y();
        }
        function v() {
          b(), i();
        }
          ...
          for (var H in n.elementAttributes)
            "+" == H.charAt(0)
              ? ((H = H.slice(1)),
                L.setAttribute(
                  H,
                  L.getAttribute(H) + n.elementAttributes["+" + H]
                ))
              : L.setAttribute(H, n.elementAttributes[H]);
        return (
          ...
          L.addEventListener("keydown", function (e) {
            ...
            switch (e.keyCode) {
              ...
              case 40:
                (t = T.indexOf(k)),
                  ("editor" == R || ("hybrid" == R && t < T.length - 1)) &&
                    (e.stopImmediatePropagation(),
                    e.stopPropagation(),
                    e.preventDefault(),
      ...
      star: function (e, t, o, i, n) {
        ...
        var r = this,
          ...
          d = l.getElementsByTagName("svg")[0]
            ? l.getElementsByTagName("svg")[0].getAttribute("width")
            : 14,
          h = [],
          ...
          for (var f in n.elementAttributes)
            "+" == f.charAt(0)
              ? ((f = f.slice(1)),
                m.setAttribute(
                  f,
                  m.getAttribute(f) + n.elementAttributes["+" + f]
                ))
              : m.setAttribute(f, n.elementAttributes[f]);
        return (
          ...
          return l
            ? e
              ? u
                ...
                : r.checked
              : r.checked && !u
              ? ((r.checked = !1), (r.indeterminate = !0), (u = !0), c)
              : ((u = !1), r.checked)
            : r.checked;
        }
        var a = e.getValue(),
          ...
          for (var d in n.elementAttributes)
            "+" == d.charAt(0)
              ? ((d = d.slice(1)),
                r.setAttribute(
                  d,
                  r.getAttribute(d) + n.elementAttributes["+" + d]
                ))
              : r.setAttribute(d, n.elementAttributes[d]);
        return (
          (r.value = a),
          !l ||
            (void 0 !== a && a !== c && "" !== a) ||
            ((u = !0), (r.indeterminate = !0)),
      ...
      function t(e, n) {
        ...
        if (
          ...
          for (var a = 1; a < e.height; a++)
            void 0 === o[n + a] && (o[n + a] = []), o[n + a].push(!1);
          ...
          if (e) {
            ...
            (t.colSpan = e.width),
              ...
              e.component._column.parent &&
                i.mapElementStyles(e.component._column.parent.groupElement, t, [
                  "border-top",
                ]),
              n.appendChild(t);
          }
        ...
        e.columns.forEach(function (a) {
          if (a) {
            ...
            c instanceof Node ? r.appendChild(c) : (r.innerHTML = c),
              ...
              s.appendChild(r),
              u.modules.format &&
                u.modules.format.renderedCallback &&
                u.modules.format.renderedCallback(),
              t.rowFormatter &&
    ...
    function o(t) {
      ...
      if (
              ...
              case "partial":
                (o = function (o) {
                  ...
                  return (
                    void 0 !== i &&
                    null !== i &&
                    String(i).toLowerCase().indexOf(String(t).toLowerCase()) >
                      -1
                  );
                }),
                  (r = "like");
        ...
        (l = JSON.stringify(n.headerFilters)),
          n.prevHeaderFilterChangeCheck !== l &&
            ((n.prevHeaderFilterChangeCheck = l),
            (n.changed = !0),
          ...
          m
            ...
            : h.table.modules.localize.bind(
                ...
                function (e) {
                  a.setAttribute(
                    "placeholder",
                    void 0 !== h.column.definition.headerFilterPlaceholder &&
  ...
  (T.prototype.initializeColumn = function (e) {
        ...
        case "string":
          "tick" === i &&
            ...
            this.formatters[i]
              ...
              : (console.warn("Formatter Error - No such formatter found: ", i),
      ...
      var o = e.getComponent(),
        i =
          "function" == typeof e.column.modules.format.params
            ? e.column.modules.format.params(o)
    ...
    (T.prototype.formatExportValue = function (e, t) {
      ...
      if (i) {
        ...
        return (
          (o = "function" == typeof i.params ? i.params(component) : i.params),
    ...
    (T.prototype.formatters = {
      ...
      link: function (e, t, o) {
        ...
        if (
          (t.labelField && ((i = e.getData()), (r = i[t.labelField])), t.label)
        )
      ...
      datetimediff: function (e, t, o) {
        ...
        return u.isValid()
          ? r
            ? moment.duration(u.diff(l)).humanize(s)
            : u.diff(l, a) + (s ? " " + s : "")
          : !0 === n
          ? c
          : "function" == typeof n
      ...
      progress: function (e, t, o) {
        ...
        switch (
          ((n = parseFloat(l) <= d ? parseFloat(l) : d),
          ...
          if (
            ...
            s instanceof r
              ? (n.addEventListener("change", function (e) {
                ...
                this.table.modules.selectRow.registerRowSelectCheckbox(s, n))
              : (n = "");
          } else
            n.addEventListener("change", function (e) {
        ...
        if (
          ...
          o.includes(s) || (t.layoutElement(s, i), o.push(s)),
            i.modules.frozen.edge &&
              s.classList.add("tabulator-frozen-" + i.modules.frozen.position);
    ...
    (H.prototype.addBindings = function () {
      ...
      n.groupManager.table.options.groupClick &&
        n.element.addEventListener("click", function (e) {
          n.groupManager.table.options.groupClick.call(
            n.groupManager.table,
            e,
            n.getComponent()
          );
        }),
        n.groupManager.table.options.groupDblClick &&
          n.element.addEventListener("dblclick", function (e) {
            n.groupManager.table.options.groupDblClick.call(
              n.groupManager.table,
              e,
              n.getComponent()
            );
        ...
        n.groupManager.table.options.groupContext &&
          n.element.addEventListener("contextmenu", function (e) {
            n.groupManager.table.options.groupContext.call(
              n.groupManager.table,
              e,
              n.getComponent()
            );
          }),
        (n.groupManager.table.options.groupContextMenu ||
          n.groupManager.table.options.groupClickMenu) &&
          n.groupManager.table.modExists("menu") &&
          n.groupManager.table.modules.menu.initializeGroup.call(
            n.groupManager.table.modules.menu,
            n
          ),
        ...
        n.groupManager.table.options.groupDblTap &&
          ...
          n.element.addEventListener("touchend", function (t) {
            e
              ? (clearTimeout(e),
                (e = null),
                n.groupManager.table.options.groupDblTap(t, n.getComponent()))
              : (e = setTimeout(function () {
                  clearTimeout(e), (e = null);
                }, 300));
          })),
      ...
      return this.groupIDLookups.length
        ? (this.table.options.dataGrouping.call(this.table),
          ...
          this.table.options.dataGrouped &&
            this.table.options.dataGrouped.call(this.table, this.getGroups(!0)),
  ...
  (A.prototype.clear = function () {
    ...
    (A.prototype._rebindRow = function (e, t) {
      this.history.forEach(function (o) {
        if (o.component instanceof l) o.component === e && (o.component = t);
    ...
    (_.prototype._extractHeaders = function (e, t) {
      for (var o = 0; o < e.length; o++) {
        ...
        r ? (a = !0) : (r = { title: s.textContent.trim() }),
          r.field ||
            (r.field = s.textContent.trim().toLowerCase().replace(" ", "_")),
            ...
            (i &&
              ...
              (i =
                !0 === i
                  ...
                  : this.table.addRow(Object.assign({}, i))),
              i.then(function () {
                setTimeout(function () {
                  t.next();
                });
  ...
  (N.prototype.initializeColumnHeader = function (e) {
    ...
    (N.prototype.LoadMenuEvent = function (e, t, o) {
      (t =
        "function" == typeof t ? t.call(this.table, e.getComponent(), o) : t),
        this.loadMenu(o, e, t);
    }),
        ...
        function (i) {
          clearTimeout(n),
            ...
            (n = setTimeout(function () {
              clearTimeout(n), (n = null), (s = !0), o.LoadMenuEvent(e, t, i);
            }, 1e3));
        },
        { passive: !0 }
      ),
    ...
    (N.prototype.initializeCell = function (e) {
      e.column.definition.contextMenu &&
        (e
          ...
          .addEventListener(
            "contextmenu",
            this.LoadMenuEvent.bind(this, e, e.column.definition.contextMenu)
          ),
        ...
        e.column.definition.clickMenu &&
          e
            ...
            .addEventListener(
              "click",
              this.LoadMenuEvent.bind(this, e, e.column.definition.clickMenu)
            );
    }),
    (N.prototype.initializeRow = function (e) {
      this.table.options.rowContextMenu &&
        (e
          ...
          .addEventListener(
            "contextmenu",
            this.LoadMenuEvent.bind(this, e, this.table.options.rowContextMenu)
          ),
        ...
        this.table.options.rowClickMenu &&
          e
            ...
            .addEventListener(
              "click",
              this.LoadMenuEvent.bind(this, e, this.table.options.rowClickMenu)
            );
    }),
    ...
    (N.prototype.positionMenu = function (e, t, o, i) {
      ...
      t
        ? ((a = h.prototype.helpers.elOffset(t)),
        ...
        (i.mousemove = function (i) {
          e.parent === o.moving.parent &&
            ((o.touchMove ? i.touches[0].pageX : i.pageX) -
              h.prototype.helpers.elOffset(t).left +
              o.table.columnManager.element.scrollLeft >
            e.getWidth() / 2
              ? (o.toCol === e && o.toColAfter) ||
                (t.parentNode.insertBefore(o.placeholderElement, t.nextSibling),
                o.moveColumn(e, !0))
              : (o.toCol !== e || o.toColAfter) &&
    ...
    (B.prototype.startMove = function (e, t) {
      ...
      (this.moving = t),
        (this.startX =
          ...
          h.prototype.helpers.elOffset(o).left),
    ...
    (B.prototype.moveHover = function (e) {
      var t,
        ...
        s =
          ...
          h.prototype.helpers.elOffset(i).left +
          n;
    ...
    (O.prototype.initializeGroupHeader = function (e) {
      ...
      (o.mouseup = function (e) {
        ...
        (o.mousemove = function (o) {
          if (
            o.pageY -
              h.prototype.helpers.elOffset(e.element).top +
    ...
    (O.prototype.initializeRow = function (e) {
      ...
      (i.mouseup = function (t) {
        ...
        (i.mousemove = function (t) {
          var i = e.getElement();
          t.pageY -
            h.prototype.helpers.elOffset(i).top +
      ...
      t.addEventListener(
        ...
        t.addEventListener("touchend", function (e) {
          c.checkTimeout && clearTimeout(c.checkTimeout),
            c.moving && (c.endMove(e), (c.touchMove = !1));
        });
    }),
  ...
  (I.prototype.initializeColumn = function (e) {
    ...
    this.allowedTypes.forEach(function (n) {
      ...
      e.definition[a] &&
        (s = t.lookupMutator(e.definition[a])) &&
        ((o = !0),
        (i[a] = { mutator: s, params: e.definition[a + "Params"] || {} }));
    }),
    ...
    (V.prototype._getRemotePage = function () {
      ...
      return new Promise(function (n, s) {
        if (
          ...
          (e = h.prototype.helpers.deepClone(
          ...
          switch (this.mode) {
            case "progressive_load":
              1 == this.page
                ...
                : this.table.rowManager.addRows(e[this.dataReceivedNames.data]),
                this.page < this.max &&
                  setTimeout(function () {
                    i.nextPage()
                      .then(function () {})
  ...
  (j.prototype.localStorageTest = function () {
    ...
    (j.prototype.initialize = function () {
      ...
      (this.mode = !0 !== t ? t : this.localStorageTest() ? "local" : "cookie"),
        ...
        (this.id =
          "tabulator-" + (o || this.table.element.getAttribute("id") || "")),
        (this.config = {
          sort:
      ...
      return (
        ...
        t.forEach(function (t, n) {
          var s,
            a = o._findColumn(e, t);
          a &&
            (!0 === o.config.columns || void 0 == o.config.columns
              ? ((s = Object.keys(a)), s.push("width"))
              : (s = o.config.columns),
            s.forEach(function (e) {
      ...
      return (
        e.forEach(function (e) {
          ...
          e.isGroup
            ...
            : ((s.field = e.getField()),
              !0 === t.config.columns || void 0 == t.config.columns
                ? ((n = Object.keys(a)), n.push("width"))
                : (n = t.config.columns),
              n.forEach(function (t) {
                switch (t) {
                  case "width":
  ...
  (U.prototype.initializeColumn = function (e, t, o) {
    ...
    if (
      ("header" === e &&
        ((n =
          "textarea" == t.definition.formatter || t.definition.variableHeight),
      ...
      var c = function (e) {
        var o, n, s;
        (o = t.getFirstColumn()) &&
          ((n = i.table.columnManager.findColumnIndex(o)),
          (s = n > 0 && i.table.columnManager.getColumnByIndex(n - 1)) &&
            i._checkResizability(s) &&
            ((i.startColumn = t), i._mouseDown(e, s, r)));
      };
    ...
    (U.prototype._mouseDown = function (e, t, o) {
      ...
      function n(e) {
        s.startColumn.modules.edit && (s.startColumn.modules.edit.blocked = !1),
          ...
          s.table.options.persistence &&
            s.table.modExists("persistence", !0) &&
            s.table.modules.persistence.config.columns &&
            s.table.modules.persistence.save("columns"),
    ...
    (K.prototype._selectRow = function (e, t, o) {
      ...
      i
        ? -1 == this.selectedRows.indexOf(i) &&
          ...
          t ||
            this.table.options.rowSelected.call(this.table, i.getComponent()),
  ...
  (J.prototype.initializeColumn = function (e, t) {
    ...
    (e.modules.sort = {
      ...
      (void 0 === e.definition.headerSort
        ...
        "object" == _typeof(this.table.options.headerSortElement)
    ...
    (J.prototype.findSorter = function (e) {
      ...
      if (o && ((o = o.getData()), e.getField()))
        switch (
          ((t = e.getFieldValue(o)), void 0 === t ? "undefined" : _typeof(t))
        ) {
          case "undefined":
            i = "string";
            break;
    ...
    (J.prototype.sorters = {
      ...
      string: function (e, t, o, i, n, s, a) {
        ...
        if (e) {
          if (t) {
            ...
            return String(e)
              .toLowerCase()
              .localeCompare(String(t).toLowerCase(), r);
          }
          c = 1;
        } else c = t ? -1 : 0;
        return (
          (("top" === l && "desc" === s) || ("bottom" === l && "asc" === s)) &&
            (c *= -1),
          c
        );
      },
      ...
      array: function (e, t, o, i, n, s, a) {
        ...
        if (Array.isArray(e)) {
          if (Array.isArray(t))
            return (l = e ? r(e) : 0), (c = t ? r(t) : 0), l - c;
          d = 1;
        } else d = Array.isArray(t) ? -1 : 0;
        return (
          (("top" === d && "desc" === s) || ("bottom" === d && "asc" === s)) &&
            (h *= -1),
          h
        );
      },
        ...
        if (e || 0 === e) {
          if (t || 0 === t) {
            ...
            for (
              r = r.match(p),
                l = l.match(p),
                d = r.length > l.length ? l.length : r.length;
              h < d;
  ...
  return (
    ...
    ($.prototype._buildValidator = function (e, t) {
      ...
      return o
        ? { type: "function" == typeof e ? "function" : e, func: o, params: t }
        : (console.warn(
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  b = a.concat(b);
  const o = new Tabulator("#_dm-tabulatorBasic", {
      data: a,
      autoColumns: !0,
      layout: "fitColumns",
    }),
    m = new Tabulator("#_dm-tabulatorFormatHead", {
      data: a,
      layout: "fitColumns",
      columns: [
        {
    ...
    k = new Tabulator("#_dm-tabulatorBorderedTable", {
      data: a,
      layout: "fitColumns",
      columns: [
        { title: "Name", field: "name", sorter: "string" },
    ...
    j = new Tabulator("#_dm-tabulatorPagination", {
      data: b,
      layout: "fitColumns",
      pagination: "local",
      paginationSize: 5,
    ...
    n = new Tabulator("#_dm-tabulatorEditData", {
      data: b,
      layout: "fitColumns",
      pagination: "local",
      paginationSize: 5,
    ...
    i = () => '<i class="demo-pli-question fs-5"></i>',
    p = new Tabulator("#_dm-tabulatorFormatData", {
      data: b,
      layout: "fitColumns",
      height: "300px",
      columns: [
        {
          ...
          width: 70,
          hozAlign: "center",
          cellClick: function (b, a) {
            alert("Printing row data for: " + a.getRow().getData().name);
          },
        },
        {
          title: "Name",
    ...
    f = document.getElementById("_dm-filterField"),
    c = document.getElementById("_dm-filterType"),
    d = document.getElementById("_dm-filterValue");
  function h(a) {
    return a.car && a.rating < 3;
  }
  function e() {
    let a = f.options[f.selectedIndex].value,
      b = c.options[c.selectedIndex].value;
    const e = a == "function" ? h : a;
    a == "function"
      ? ((c.disabled = !0), (d.disabled = !0))
      : ((c.disabled = !1), (d.disabled = !1)),
      a && g.setFilter(e, b, d.value);
  }
  document.getElementById("_dm-filterField").addEventListener("change", e),
    document.getElementById("_dm-filterType").addEventListener("change", e),
    document.getElementById("_dm-filterValue").addEventListener("keyup", e),
    document
      .getElementById("_dm-filterClear")
      .addEventListener("click", function () {
        (f.value = "none"), (c.value = "like"), (d.value = ""), g.clearFilter();
      });
  const g = new Tabulator("#_dm-tabulatorFilter", {
    data: [
      {
        id: 1,
        name: "Oli Bob",
